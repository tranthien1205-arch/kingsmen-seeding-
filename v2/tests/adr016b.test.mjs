...
test('016b: thầy Claude đọc đoạn, nhãn đóng, chi phí mục học, hết ngân sách dừng lô, bảng đo tách thầy / mô hình mở', async () => {
  ...
  await may('/hub/doc-khung', 'POST', { tai_san_id: ts, timeline: [{ tu: 0, den: 3, nhom: 'THI_CONG', buoc: 'Gạt phẳng', can_xac_nhan: true, nguon_nhan: 'THAY', mo: { nhom: 'HOAN_THIEN', chac: 1 }, thay: { nhom: 'THI_CONG', buoc: 'Gạt phẳng', chac: 0.45, model: 'claude-sonnet-4-5', ly_do: 'tay cầm bay' } }, { tu: 3, den: 6, nhom: 'HOAN_THIEN', can_xac_nhan: false, nguon_nhan: 'THAY', mo: { nhom: 'THI_CONG' }, thay: { nhom: 'HOAN_THIEN', chac: 0.9 } }] });
