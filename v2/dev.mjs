...
const env = { DB: taoD1(DBFILE), ASSETS, ...Object.fromEntries(Object.entries(process.env).filter(([k]) => /^(ANTHROPIC_|YOUTUBE_|N8N_|TOKEN_|GOOGLE_|GEMINI_|OPENAI_|GROQ_|DEEPINFRA_|TOGETHER_|VLLM_|APP_BASE_URL)/.test(k))) };
