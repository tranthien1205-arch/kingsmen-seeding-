...
export const CHUAN = {
  ...
  bai_test: [
    ...
    [/đổ nước|xịt nước|test nước|thoát nước|thấm|khô ráo/i, 'Đổ nước thử chống thấm'],
  ...
  buoc: [
    [/^(vệ sinh|thi công chính|thi công [\d.,]+.*|tùy .*|giới thiệu .*|lựa chọn .*|thực hiện trên .*)$/i, null],
