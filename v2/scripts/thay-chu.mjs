...
d1(`INSERT INTO module_config (id,cau_hinh,updated_at,updated_by_name) VALUES ('lenh_thay_chu',${sqlChuoi(JSON.stringify({ lenh: ds }))},${sqlChuoi(new Date().toISOString())},'Claude') ON CONFLICT(id) DO UPDATE SET cau_hinh=excluded.cau_hinh, updated_at=excluded.updated_at, updated_by_name=excluded.updated_by_name`);
