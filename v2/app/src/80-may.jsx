...
function KyNang({a, duoc, db}){
  ...
  const loiKhuyen=k=>{ if(k.trang_thai==='MOI') return 'Bản mới khớp người '+k.ban_moi.diem+'/100 trên '+k.ban_moi.n_kiem+' mẫu kiểm (quy tắc cũ '+k.ban_moi.diem_truoc+'). Xem thử rồi bật.'; if(k.trang_thai==='NHA') return 'Máy nhà đang làm'+(k.dang_dung?(', bản '+k.dang_dung.phien_ban+' khớp người '+k.dang_dung.diem+'/100'):'')+'. AI ngoài dự phòng khi máy im.'; if(k.trang_thai==='DANG_HOC') return 'Máy đang học, vài phút nữa có bản mới để xem thử.'; if(k.trang_thai==='DU_MAU') return 'Đủ ví dụ. Máy tự học ở lượt tới (mỗi giờ), hoặc bấm "Học ngay".';
