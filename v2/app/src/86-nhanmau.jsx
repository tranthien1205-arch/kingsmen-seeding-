...
function NguonHoc({ a }) {
  ...
  const Nut = ({ g }) => <div className="flex gap-1.5 flex-wrap items-center">{g.nap && duoc && <button className={nutCls + ' !py-0.5'} disabled={busy} onClick={() => hocThem(g)} title={'nạp lại: ' + g.nap}>＋ Học thêm video mới</button>}
